...
object TouchDemoLogger {
    ...
    fun logTouch(action: Int, viewName: String, function: String, result: Boolean) {
        ...
        val message = "TouchDemoLogger: $actionName event called in $viewName's $function res: $result"
        Timber.d(message)
    }
}
